...
const DOMAIN_DEFINITIONS_URL = "http://localhost:63342/ProprietaryCohorts/src/server/domains.json"
const COHORT_DEFINITIONS_URL = "http://localhost:63342/ProprietaryCohorts/src/server/cohortDefinitions.json";
...
if (ProprietaryCohorts) {
    ProprietaryCohorts.classifier = function (url, state) {
        ...
        const domainDefinitionsPromise = utils.request(DOMAIN_DEFINITIONS_URL, 'GET')
            .then(response => {
